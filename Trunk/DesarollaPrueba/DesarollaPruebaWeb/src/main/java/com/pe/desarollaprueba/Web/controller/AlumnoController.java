...
public class AlumnoController extends HttpServlet {
     ...
     */
    	private final static String MENSAJE_INSERTAR = "Se inserto correctamente el Alumno";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
             ...
             String sedecbx=request.getParameter("sedecbx");
                ...
                alum.setSexo(sexo);
                int id=Integer.parseInt(sedecbx);
                
                sedetmp=sedeService.obtener(id);
                ...
                alumnoService.insertar(alum);
                
		

               response.sendRedirect(request.getContextPath()+"/CrearAlumno.jsp?mensaje="+MENSAJE_INSERTAR); 
               } catch(Exception ex)
               {
               ...
               response.sendRedirect(request.getContextPath()+"/CrearAlumno.jsp?mensaje="+MENSAJE_ERROR+ex.getMessage()); 
