...
<%-- 
    ...
    Created on : 16/02/2015, 12:32:29 PM
    Author     : JonathaN
--%>
...
<%
   ...
   AlumnoService alumnoService=(AlumnoService)WebUtil.obtenerService("Alumno");
   
   List<Sede>  listSede=new ArrayList<Sede>();   
 
  
   try {  
       alum=alumnoService.obtener(Integer.parseInt(id)); 
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse text-center">
                            <ul class="nav navbar-nav" style="float:none;">
                               ...
                               <li class="col-sm-3 col-md-3 col-lg-3 hovermenu"><a href="ListarSede.jsp" class="menu-estil"><div class="text-center FuenteMenu">Lista De Sedes</div></a></li>
       ...
       <div class="container">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          ...
          <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                 <h1 class="page-header">Actualizar de Alumnos</h1>
                </div>
            </div>                            
          </div>
       
            <form method="POST" action="ActualizarAlumnoController?id=<%=id %>"  >
        <div class="form-group">
          <label for="exampleInputName2">Codigo</label>
          <input type="text" class="form-control" name="txtCodigo" value="<%= alum.getCodAlumno().toString() %> "  required pattern="[a-zA-Z1-9]" maxlength="40">
        </div>
                
        <div class="form-group">
          <label for="exampleInputName2">Nombre</label>
         <input type="text" class="form-control" name="txtNombre" value="<%= alum.getNombre().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Apellido</label>
          <input type="text" class="form-control" name="txtApellido" value="<%= alum.getApellido().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Direccion</label>
          <input type="text" class="form-control" name="txtDireccion" value="<%= alum.getDireccion().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Dni</label>
          <input type="text" class="form-control"  name="txtDni" value="<%= alum.getDni().toString() %>" required pattern="[1-9]" maxlength="20">>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Telefono</label>
          <input type="text" class="form-control" name="txtTelefono" value="<%= alum.getTelefono().toString() %>"required pattern="[1-9]" maxlength="15">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Celular</label>
          <input type="text" class="form-control" name="txtCelular" value="<%= alum.getCelular().toString() %>"  required pattern="[1-9]" maxlength="10">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Edad</label>
          <input type="text" class="form-control" name="txtEdad" value="<%= alum.getEdad().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="3">
        </div>
        <div class="form-group">
         <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                             <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                <label for="sede">Elija el sexo del alumno:</label>
                            </div>
                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">                               
                                <select name="Sexocbx" id="sede" class="form-control"  >
                    ...
                    <div class="form-group row">
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                             <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                <label for="sede">Elija la Sede del alumno:</label>
                            </div>
                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">                               
                                <select name="sedecbx" id="sede" class="form-control"  >
                                    <% for (Sede Se : listSede) {%>
                                    <option value=<%=Se.getIdSede()%>> <%= Se.getNombre()%></option>
                                    <% }%>
                                </select>
                            </div>
        ...
        <button  class="btn btn-default " name="btnCrearAlumno" >   <b>Actualizar Alumno </b></a></button>
      </form>
