       ...
       <div class="container">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          ...
          <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                 <h1 class="page-header">Crear de Alumnos</h1>
                </div>
            </div>                            
          </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="txtCodigo" placeholder="Jane Doe" required pattern="[a-zA-Z1-9]" maxlength="40">
        </div>
                
        <div class="form-group">
          <label for="exampleInputName2">Nombre</label>
          <input type="text" class="form-control" name="txtNombre" placeholder="Jane Doe" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Apellido</label>
          <input type="text" class="form-control" name="txtApellido" placeholder="Apellido" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Direccion</label>
          <input type="text" class="form-control" name="txtDireccion"  placeholder="Direccion" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Dni</label>
          <input type="text" class="form-control" name="txtDni" placeholder="DNI"required pattern="[1-9]" maxlength="20">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Telefono</label>
          <input type="text" class="form-control" name="txtTelefono" placeholder="Telefono"required pattern="[1-9]" maxlength="15">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Celular</label>
          <input type="text" class="form-control" name="txtCelular" placeholder="jane.doe@example.com" required pattern="[1-9]" maxlength="10">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Edad</label>
          <input type="text" class="form-control" name="txtEdad" placeholder="jane.doe@example.com" required pattern="[a-zA-Z1-9]" maxlength="3">
        </div>
        <div class="form-group">
         <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <button  class="btn btn-default " name="btnCrearAlumno" >   <b>Crear Alumno </b></a></button>
      </form>
