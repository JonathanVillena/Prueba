...
<%
   ...
   try {  
       sede=SedeSer.obtener(Integer.parseInt(id)); 
     } catch(Exception ex)
  {
...
$(document).ready(function() {
  ...
  .marginSession{
    ...
    <div class="wrapper">
       ...
       <form action="ActualizarSedeController?id=<%=id %>" method="POST">
        <div class="form-group">
          <label for="exampleInputName2">Nombre</label>
          <input type="text" class="form-control" name="txtNombreSede" value="<%= sede.getNombre().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="40">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Distrito</label>
          <input type="text" class="form-control" name="txtDistritoSede" value="<%= sede.getDistrito().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Direccion</label>
          <input type="text" class="form-control" name="txtDireccionSede"  value="<%= sede.getDireccion().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="50">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail2">Aforo</label>
          <input type="text" class="form-control" name="txtAforoSede" value="<%= sede.getAforo().toString() %>" required pattern="[1-9]" maxlength="5">
        </div>
    <div class="form-group">
          <label for="exampleInputEmail2">Telefono</label>
          <input type="text" class="form-control" name="txtTelefonoSede" value="<%= sede.getTelefono().toString() %>" required pattern="[a-zA-Z1-9]" maxlength="30">
        </div>
       <button  class="btn btn-default ">   <b>Actualizar Sede </b></a></button>
      </form>
